...
const kayıtlı = message.guild.roles.cache.find(r => r.id === '798529423514796042')
const kayıtlı2 = message.guild.roles.cache.find(r => r.id === '798529414861815849')
const kayıtlı3 = message.guild.roles.cache.find(r => r.id === '798549261447856169')
